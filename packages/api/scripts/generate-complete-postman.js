        ...
        },
        {
          ...
          "request": {
            ...
            "url": {
              ...
              "host": ["{{baseUrl}}"],
              "path": ["groups", "code", "{{classroomCode}}"]
            }
          }
        },
        {
          ...
          "request": {
            ...
            "url": {
              ...
              "host": ["{{baseUrl}}"],
              "path": ["groups", "{{familyGroupId}}", "children"],
              "query": [
                {
                  "key": "type",
                  "value": "family"
        ...
        },
        {
          ...
          "request": {
            ...
            "url": {
              ...
              "host": ["{{baseUrl}}"],
              "path": ["groups", "{{classroomGroupId}}", "children"],
              "query": [
                {
                  "key": "type",
                  "value": "classroom"
        ...
        },
        {
          ...
          "request": {
            ...
            "url": {
              ...
              "host": ["{{baseUrl}}"],
              "path": ["groups", "{{familyGroupId}}", "regenerate-code"]
            }
          }
        }
      ]
        ...
        },
        {
          ...
          "request": {
            ...
            "url": {
              ...
              "host": ["{{baseUrl}}"],
              "path": ["groups", "{{classroomGroupId}}", "regenerate-code"]
            }
          }
        }
      ]
...
fs.writeFileSync('postman-collection-complete.json', JSON.stringify(collection, null, 2));

console.log('✅ Complete Postman collection created: postman-collection-complete.json');
console.log('\n📋 Instructions:');
console.log('1. Import postman-collection-complete.json into Postman');
console.log('2. All protected routes already have authentication headers');
console.log('3. Test the public routes first (no auth needed)');
console.log('4. Then test the protected routes (auth included)');
console.log('\n🔑 Tokens included:');
console.log('- Parent Token: For family operations');
console.log('- Teacher Token: For classroom operations');
console.log('\n🎯 Test order:');
console.log('1. Health Check');
console.log('2. Public Routes (Get by Code, Get Children)');
console.log('3. Protected Routes (Create, Update, Regenerate)');
console.log('4. Test Scenarios (Complete flows)');
